...
<body>
	<div id="container">
		...
		<article class="entry">
			...
			<!-- header named 'Melbourne'-->
				<h1>Melbourne</h1>
				<!-- Paragraph-->
				<p>Highlights in Melbourne.</br>
  ...
  <head>
    ...
    var customIcons = {
      ...
      Centre: {
        icon: 'images/marker/conference.png'
      },
      Nature: {
        icon: 'images/marker/tree.png'
      },
      Stadiums: {
        icon: 'images/marker/tennis.png'
      },
      ObservationPoint: {
        icon: 'images/marker/moderntower.png'
      },
    };
	//loading the map
    function load() {
      var map = new google.maps.Map(document.getElementById("map"), {
        ...
        center: new google.maps.LatLng(-37.819633, 144.973397),
		...
		scaleControl: false,
		//allowing the map to be draggable
		draggable: true,
  ...
  <body onload="load()">
    <div id="map" style="width: 100%; height: 450px"></div>
			...
			//variables to define each code to prevent repetition
				//query_select defines the query used to pull the data. Selecting all from table "markers" to match city "Melbourne" and order "ID" by Ascending
				$query_select = "SELECT * FROM DSA_POIMELBOURNE ORDER BY id ASC ";
